...
try:
    ...
    # 1 Maiores
    plt.subplot(2, 1, 1)
    df_roubo_veiculo_maiores = df_roubo_veiculo_maiores.sort_values(by='roubo_veiculo', ascending=True).head(10)
    ...
    # 2 Menores
    plt.subplot(2, 1, 2)
    df_roubo_veiculo_menores = df_roubo_veiculo_menores.sort_values(by='roubo_veiculo', ascending=False)
